...
<body>
	...
	<div>
		<img src="<%=request.getContextPath() %>/images/error404.jpg" width="100%" alt="" border="0" />
	</div>
	<!-- 
	HTTP 프로토콜은 응답상태 코드를 이용하여
	서버의 처리 결과를 웹브라우저에 알려주며,
	...
	405 - 요청된 메소드는 허용불가 (get방식, post방식) 일 때
	500 - 서버 내부 에러..JSP 에서 익셉션이 발생했을 경우
	503 - 서버 부하. 예) 디도스
	
	JSP 가 정상적으로 실행되는 응답 코드로 200이 전송되며,
